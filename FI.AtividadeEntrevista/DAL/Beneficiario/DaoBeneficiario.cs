...
namespace FI.AtividadeEntrevista.DAL
{
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal DML.Beneficiario Consultar(long Id)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_ConsTodosBeneficiario", parametros);
            List<DML.Beneficiario> ben = Converter(ds);

            return ben.FirstOrDefault();
        }

        internal List<DML.Beneficiario> ConsultaPeloCliente(long IdCliente = 0)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
        ...
        internal bool VerificarExistencia(string CPF, long IdCliente = 0)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
